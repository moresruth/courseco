          ...
          <div class="feature-item">
            ...
            <div class="icon"><i class="fas fa-search"></i></div>
              ...
              <?php
                  ...
                  <?php else: ?>
                    <a style="font-size: 20px; font-weight: bold; color:black; text-decoration: none; " href="https://courseco-predictor.herokuapp.com/"><h4>Specialization Track Prediction</h4></a>
                  <?php endif ?>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="owl-carousel features-carousel">
          <div class="feature-item">
            <div class="icon" ><i class="fas fa-search" ></i></div>
            <a style="font-size: 20px; font-weight: bold; color:black; text-decoration: none;" href="https://specializationtrackpredictor.herokuapp.com/"> Specialization Track Prediction</a>
            <p>
              Take the test to find which specialization track in Information Technology Education fits in your interest.
          ...
          <div class="feature-item">
            <div class="icon"><i class="fas fa-search"></i></div>
            <a style="font-size: 20px; font-weight: bold; color:black; text-decoration: none;" href="https://courseco1.ruthantonette.com/description.php">Explore Specializations</a>
            <p>
              Explore more about the specialization track. Gain knowledge of what the track has to offer
            </p>
          </div>
          <div class="feature-item">
            <div class="icon"><i class="fas fa-search"></i></div>
            <a  style="font-size: 20px; font-weight: bold; color:black; text-decoration: none;" href="https://courseco1.ruthantonette.com/courses.php">Online Courses</a>
            <p>
              Learn from a different of sources, including useful educational links and study tools.
            </p>
          </div>
          ...
          <div class="row ">
                ...
                <div class="col-lg-12 col-md-12">
                  ...
                  <br>
                    ...
                    <a href="https://courseco-predictor.herokuapp.com/" class="btn btn-2">Get Started</a>
                  </div>
              </div>
          </div>
