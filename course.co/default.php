            ...
            <?php
				...
				if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
                 ...
                 <?php else: ?>
					...
					<a class="home-btn btn btn-1" href=" https://courseco-predictor.herokuapp.com/">Get Started!</a>
            <?php endif ?>     
          </div>
        </div>
          ...
          <div class="feature-item">
            ...
            <div class="icon"><i class="fas fa-search"></i></div>
              ...
              <?php
                  ...
                  <?php else: ?>
                    <a style="font-size: 20px; font-weight: bold; color:black; text-decoration: none; " href="https://courseco-predictor.herokuapp.com/">Specialization Track Prediction</a>
                  <?php endif ?>
